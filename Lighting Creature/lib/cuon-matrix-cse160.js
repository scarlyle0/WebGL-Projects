...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        let v3 = new Vector3([(other1.elements[1]*other2.elements[2]) - (other1.elements[2]*other2.elements[1]), (other1.elements[2]*other2.elements[0]) - (other1.elements[0]*other2.elements[2]), (other1.elements[0]*other2.elements[1]) - (other1.elements[1]*other2.elements[0])]);
        // Don't delete the return statement.
        return v3;
    }
    ...
    /**
      ...
      */
    magnitude() {
        let m = Math.pow(this.elements[0], 2) + Math.pow(this.elements[1], 2) + Math.pow(this.elements[2], 2); // Modify this line to calculate this vector's magnitude.
        m = Math.sqrt(m);
        return m;
    };
    ...
    normalize() {
        ...
        this.elements[0] = this.elements[0]/magni;
        this.elements[1] = this.elements[1]/magni;
        this.elements[2] = this.elements[2]/magni;
        // Don't delete the return statement.
        return this;
    };
}
