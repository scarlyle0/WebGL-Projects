...
function renderGuardianParts(translatex, translatez, rotation){
  var body = new Cube(0.8, 0.9, 1, 0.6, 0.9, 0.6);
  body.color = [171/200, 169/200, 159/200, 1.0];
  body.matrix.translate(translatex, 0.1 + Math.sin(.5*g_seconds)*0.3, translatez);
  body.matrix.rotate(-g_bodyAngle + rotation, 0, 1, 0);
